    ...
    return (
        <>
            <div className="p-6 md:p-8 text-gray-800 leading-relaxed">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Nossos Serviços</h2>
                ...
                <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-2">📩 Denúncia Online</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-2">🔒 Sigilo e Segurança</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-2">🤝 Acolhimento e Encaminhamento</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-2">📞 Atendimento à Comunidade</h3>
                <p>
